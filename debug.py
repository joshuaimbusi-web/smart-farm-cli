...
#     main()
from lib.db.database import SessionLocal
from lib.db.models import Farmer, Activity, FarmerActivity

s = SessionLocal()
farmer = Farmer.find_by_id(s, 1)
activity = Activity.find_by_id(s, 1)
fa = FarmerActivity.create(s, farmer=farmer, activity=activity, role="leader", progress_percent=5.0, notes="Started")
s.close()
print(fa)